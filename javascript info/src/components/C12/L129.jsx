...
export default function C129({ title }) {
    const data = [
        {
            title: title,
        ...
        },
        {
            ...
            link: `https://javascript.info/comparison#boolean-is-the-result`,
            details: [
                {
                    detail: [
                        `All comparison operators return a boolean value: "true" or "false". For example:`,
                    ],
                    code: [
        ...
        },
        {
            ...
            link: `https://javascript.info/comparison#string-comparison`,
            details: [
                {
                    detail: [
        ...
        },
        {
            ...
            link: `https://javascript.info/comparison#comparison-of-different-types`,
            details: [
                {
                    detail: [
        ...
        },
        {
            ...
            link: `https://javascript.info/comparison#strict-equality`,
            details: [
                {
                    detail: [
        ...
        {
            title: `Comparison with null and undefined`,
            link: `https://javascript.info/comparison#comparison-with-null-and-undefined`,
            details: [
                {
                    detail: [
        ...
        },
        {
            ...
            link: `https://javascript.info/comparison#strange-result-null-vs-0`,
            details: [
                {
                    detail: [`Let’s compare null with a zero:`],
                    code: [
        ...
        },
        {
            ...
            link: `https://javascript.info/comparison#an-incomparable-undefined`,
            details: [
                {
                    detail: [
        ...
        },
        {
            ...
            link: `https://javascript.info/comparison#avoid-problems`,
            details: [
                {
                    detail: [
        ...
        {
            title: `Summary`,
            link: `https://javascript.info/comparison#summary`,
            details: [
                {
                    detail: [
        ...
        {
            title: `Tasks`,
            link: `https://javascript.info/comparison#tasks`,
        },
        {
            title: `Comparisons`,
            link: `https://javascript.info/comparison#comparisons`,
            details: [
                {
                    detail: [`What will be the result for these expressions?`],
                    code: [
                        `alert(5 > 4); // true`,
